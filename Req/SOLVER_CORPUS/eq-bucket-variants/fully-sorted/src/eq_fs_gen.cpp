// Driver: eq_fs_gen <n> <k> <nonce_hex> -- solves plain Equihash(n,k)
// with the fully-sorted-bucket solver and prints one JSON line.
#include "solver.hpp"
#include <cstdio>
#include <cstdlib>
#include <string>
...
int main(int argc, char** argv) {
    ...
    eq_fully_sorted::Solver solver(n, k, nonce);
