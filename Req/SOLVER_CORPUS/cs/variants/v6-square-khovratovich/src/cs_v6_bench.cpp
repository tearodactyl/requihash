// Benchmark driver: cs_v6_bench <n> <K> <nonce_hex> [--reps N] [--no-save]
// runs cs_v6::KListWagnerAlgorithmV6::solve() repeatedly (default 5 reps, Req/BENCH.md S2's
...
// Req/SOLVER_CORPUS/cs/variants/v6-square-khovratovich/runs/<n><K>_<timestamp>.jsonl -- never
...
// is. See klist_v6.hpp's own two-conventions note.
...
int main(int argc, char** argv) {
    ...
    for (int r = 0; r < reps; ++r) {
        ...
        cs_v6::KListWagnerAlgorithmV6 solver(n, K, nonce);
    ...
    snprintf(line, sizeof(line),
        "{\"impl\":\"cs-v6\",\"lang\":\"cpp\",\"point\":{\"n\":%u,\"k_or_K\":%u,\"convention\":\"list_count_K\"},"
