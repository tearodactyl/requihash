// Benchmark driver: cs_v5_bench <n> <K> <nonce_hex> [--reps N] [--no-save]
// runs cs_v5::KListWagnerAlgorithmV5::solve() repeatedly (default 5 reps, Req/BENCH.md S2's
...
// Req/SOLVER_CORPUS/cs/variants/v5-unlimited-mem/runs/<n><K>_<timestamp>.jsonl -- never
...
// is. See klist_v5.hpp's own two-conventions note.
...
int main(int argc, char** argv) {
    ...
    for (int r = 0; r < reps; ++r) {
        ...
        cs_v5::KListWagnerAlgorithmV5 solver(n, K, nonce);
    ...
    snprintf(line, sizeof(line),
        "{\"impl\":\"cs-v5\",\"lang\":\"cpp\",\"point\":{\"n\":%u,\"k_or_K\":%u,\"convention\":\"list_count_K\"},"
