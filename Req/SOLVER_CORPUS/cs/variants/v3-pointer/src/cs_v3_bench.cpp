// Benchmark driver: cs_v3_bench <n> <K> <nonce_hex> [--reps N] [--no-save]
// runs cs_v3::KListWagnerAlgorithmV3::solve() repeatedly (default 5 reps, Req/BENCH.md S2's
...
// Req/SOLVER_CORPUS/cs/variants/v3-pointer/runs/<n><K>_<timestamp>.jsonl -- never
...
// is. See klist_v3.hpp's own two-conventions note.
...
int main(int argc, char** argv) {
    ...
    for (int r = 0; r < reps; ++r) {
        ...
        cs_v3::KListWagnerAlgorithmV3 solver(n, K, nonce);
    ...
    snprintf(line, sizeof(line),
        "{\"impl\":\"cs-v3\",\"lang\":\"cpp\",\"point\":{\"n\":%u,\"k_or_K\":%u,\"convention\":\"list_count_K\"},"
