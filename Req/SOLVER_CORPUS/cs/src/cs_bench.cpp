// Benchmark driver: cs_bench <n> <K> <nonce_hex> [--reps N] [--no-save]
// runs cs::KListWagnerAlgorithm::solve() repeatedly (default 5 reps, Req/BENCH.md S2's
...
// Req/SOLVER_CORPUS/cs/runs/<n><K>_<timestamp>.jsonl -- never
...
// is. See klist.hpp's own two-conventions note.
#include "klist.hpp"
...
int main(int argc, char** argv) {
    ...
    for (int r = 0; r < reps; ++r) {
        ...
        cs::KListWagnerAlgorithm solver(n, K, nonce);
    ...
    snprintf(line, sizeof(line),
        "{\"impl\":\"cs-base\",\"lang\":\"cpp\",\"point\":{\"n\":%u,\"k_or_K\":%u,\"convention\":\"list_count_K\"},"
